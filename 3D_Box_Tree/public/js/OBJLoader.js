			...
			parse: function (text) {
				...
				for (var i = 0, l = lines.length; i < l; i++) {
					...
					if (lineFirstChar === "v") {
						...
						for (
							var j = 1, jl = faceVertices.length - 1;
							j < jl;
							j++
						) {
						...
						(result = object_pattern.exec(line)) !== null
					) {
						// o object_name
						// or
						// g group_name
				...
				for (
					var i = 0, l = state.objects.length;
					i < l;
					i++
				) {
